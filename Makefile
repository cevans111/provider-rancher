...
PROJECT_REPO := github.com/oclc/$(PROJECT_NAME)

export TERRAFORM_VERSION := 1.3.3

export TERRAFORM_PROVIDER_SOURCE := rancher/rancher2
export TERRAFORM_PROVIDER_REPO := https://github.com/rancher/terraform-provider-rancher2.git
export TERRAFORM_PROVIDER_VERSION := 1.25.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-rancher2
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-rancher_1.25.0_linux_amd64
